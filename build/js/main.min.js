...
/* harmony import */ var _modules_initResize__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/initResize */ "./js/modules/initResize.js");
...
Object(_modules_initResize__WEBPACK_IMPORTED_MODULE_4__["initResize"])();
...
/***/ "./js/modules/initResize.js":
/*!**********************************!*\
  !*** ./js/modules/initResize.js ***!
  \**********************************/
/*! exports provided: initResize */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initResize", function() { return initResize; });
var initResize = function initResize() {
  var wrapper = document.querySelector('.wrapper');
  var resizeText = document.querySelector('.resize-text');
...
var getData = function getData() {
  ...
  .catch(function (error) {// что-то отрисовать вместо слайдера
  });
};
...
var renderSlider = function renderSlider(data) {
  ...
  eventsSlider.on('update slideChange', function () {
    document.dispatchEvent(new CustomEvent('stopVideo'));
    ...
    containers.forEach(function (container) {
      ...
      var videoId = container.id;
      var player = new YT.Player(videoId, {
        videoId: videoId,
        events: {
          'onReady': function onReady() {
            var onStopVideo = function onStopVideo() {
  ...
  var updateSlider = function updateSlider() {
    ...
    filteredYears = [];
    var filteredSlides = data.years.map(function (year, index) {
  ...
  filterEnterprisesBtns.forEach(function (btn) {
    ...
    var hasEnterprises = data.years.some(function (year) {
      return data.cards[year].some(function (card) {
        return btn.dataset.orgId === String(card.org.id);
      });
    });
  ...
  filterEventsBtns.forEach(function (btn) {
    ...
    var hasEvents = data.years.some(function (year) {
      // eslint-disable-next-line max-nested-callbacks
      return data.cards[year].some(function (card) {
        return card.events.some(function (evt) {
          return btn.dataset.eventId === String(evt.id);
        });
      });
    });
...
var loadYoutubeScript = function loadYoutubeScript() {
...
var initSlider = function initSlider() {
  Promise.all([loadYoutubeScript(), getData()]).then(function (_ref3) {
