...
/* harmony import */ var _modules_scrollAnim__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/scrollAnim */ "./js/modules/scrollAnim.js");
...
Object(_modules_initIE11__WEBPACK_IMPORTED_MODULE_3__["initIE11"])(); // initResize();

Object(_modules_slider__WEBPACK_IMPORTED_MODULE_4__["initSlider"])();
Object(_modules_scrollAnim__WEBPACK_IMPORTED_MODULE_5__["initScrollAnim"])();
...
var modalFilterBtns = document.querySelectorAll('[data-modal="filter"]'); // аргументы setupModal(modal, closeCallback, modalBtns, openCallback, noPrevDefault, preventScrollLock)
...
var initModals = function initModals() {
  ...
  if (modalFilter && modalFilterBtns.length) {
    Object(_utils_modal__WEBPACK_IMPORTED_MODULE_0__["setupModal"])(modalFilter, false, modalFilterBtns);
  }
};
...
var initScrollAnim = function initScrollAnim() {
  ...
  var SCROLL_STEP = 10;
  var wrapper = document.querySelector('.wrapper');
  var header = document.querySelector('.header'); // объект модификации
...
var renderSlider = function renderSlider(data) {
  ...
  var openCard = function openCard(card) {
    ...
    var loaded = document.querySelectorAll('.loaded-element');
  ...
  var currentNum2 = document.querySelector('.time-line__second-number'); // смена цифр
