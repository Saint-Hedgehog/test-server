...
var initSlider = function initSlider() {
  if (document.querySelector('.time-line')) {
    ...
    var slider = new Swiper('.slider', {
      ...
      // slidesPerView: 'auto',
      virtual: {
        slides: _data_history_json__WEBPACK_IMPORTED_MODULE_0__.years.map(function (year, index) {
    ...
    slider.on('progress', function () {
      ...
      Object(_utils_modal__WEBPACK_IMPORTED_MODULE_1__["setupModal"])(modalSuccess, false, modalSuccessBtns);
    });
    ...
    var eventSlider = new Swiper('.event__slider', {
      slidesPerView: 1,
      speed: 1000,
      watchSlidesVisibility: true,
      observer: true,
