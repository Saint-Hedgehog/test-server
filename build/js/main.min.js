...
module.exports = JSON.parse("{\"cards\":{\"2001\":[{\"id\":1,\"events\":[{\"id\":22,\"title\":\"производство\"},{\"id\":23,\"title\":\"экология\"}],\"org\":{\"id\":4,\"title\":\"Группа ТМК\"},\"year\":2001,\"title\":\"ТМК основана в 2001 году первоначально в форме ЗАО на базе предприятия «Чермет»\",\"description\":\"В 2001 году в форме закрытого акционерного общества создана Трубная Металлургическая Компания (ТМК). Также для совершения операций по продаже продукции и закупке сырья и основных материалов создан Торговый дом ТМК (ТД ТМК).\",\"cover\":\"img/slides/slides-photo-1\",\"pictures\":[\"img/slides/slides-photo-1\",\"img/slides/slides-photo-2\",\"img/slides/slides-photo-3\",\"img/slides/slides-photo-4\"]},{\"id\":1,\"events\":[{\"id\":22,\"title\":\"производство\"},{\"id\":23,\"title\":\"экология\"}],\"org\":{\"id\":4,\"title\":\"Группа ТМК\"},\"year\":2001,\"title\":\"ТМК основана в 2001 году первоначально в форме ЗАО на базе предприятия «Чермет»\",\"description\":\"В 2001 году в форме закрытого акционерного общества создана Трубная Металлургическая Компания (ТМК). Также для совершения операций по продаже продукции и закупке сырья и основных материалов создан Торговый дом ТМК (ТД ТМК).\",\"cover\":\"img/slides/slides-photo-2\",\"pictures\":[\"img/slides/slides-photo-1\",\"img/slides/slides-photo-2\",\"img/slides/slides-photo-3\",\"img/slides/slides-photo-4\"]}],\"2002\":[{\"id\":1,\"events\":[{\"id\":22,\"title\":\"производство\"},{\"id\":23,\"title\":\"экология\"}],\"org\":{\"id\":4,\"title\":\"Группа ТМК\"},\"year\":2002,\"title\":\"ТМК основана в 2001 году первоначально в форме ЗАО на базе предприятия «Чермет»\",\"description\":\"В 2001 году в форме закрытого акционерного общества создана Трубная Металлургическая Компания (ТМК). Также для совершения операций по продаже продукции и закупке сырья и основных материалов создан Торговый дом ТМК (ТД ТМК).\",\"cover\":\"img/slides/slides-photo-3\",\"pictures\":[\"img/slides/slides-photo-1\",\"img/slides/slides-photo-2\",\"img/slides/slides-photo-3\",\"img/slides/slides-photo-4\"]},{\"id\":1,\"events\":[{\"id\":22,\"title\":\"производство\"},{\"id\":23,\"title\":\"экология\"}],\"org\":{\"id\":4,\"title\":\"Группа ТМК\"},\"year\":2002,\"title\":\"ТМК основана в 2001 году первоначально в форме ЗАО на базе предприятия «Чермет»\",\"description\":\"В 2001 году в форме закрытого акционерного общества создана Трубная Металлургическая Компания (ТМК). Также для совершения операций по продаже продукции и закупке сырья и основных материалов создан Торговый дом ТМК (ТД ТМК).\",\"cover\":\"img/slides/slides-photo-4\",\"pictures\":[\"img/slides/slides-photo-1\",\"img/slides/slides-photo-2\",\"img/slides/slides-photo-3\",\"img/slides/slides-photo-4\"]}]},\"years\":[\"2001\",\"2002\"],\"events\":[{\"id\":22,\"title\":\"производство\"},{\"id\":23,\"title\":\"экология\"}],\"orgs\":[{\"id\":4,\"title\":\"Группа ТМК\"},{\"id\":4,\"title\":\"Группа ТМК 2\"},{\"id\":4,\"title\":\"Группа ТМК 3\"}]}");
...
/* harmony import */ var _data_history_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../data/history.json */ "./data/history.json");
var _data_history_json__WEBPACK_IMPORTED_MODULE_1___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../data/history.json */ "./data/history.json", 1);

swiper__WEBPACK_IMPORTED_MODULE_0__["Swiper"].use([swiper__WEBPACK_IMPORTED_MODULE_0__["Pagination"], swiper__WEBPACK_IMPORTED_MODULE_0__["Controller"], swiper__WEBPACK_IMPORTED_MODULE_0__["Mousewheel"]]);


var initSlider = function initSlider() {
  // /* global Swiper */
  if (document.querySelector('.time-line')) {
    var slider = new swiper__WEBPACK_IMPORTED_MODULE_0__["Swiper"]('.slider', {
      slidesPerView: 'auto',
      speed: 1000,
      grabCursor: true,
      freeMode: true,
      watchSlidesVisibility: true,
      virtual: {
        slides: _data_history_json__WEBPACK_IMPORTED_MODULE_1__.years.map(function (year) {
          return "\n            <div class=\"slider__slide swiper-slide\" data-year=\"".concat(year, "\">\n              ").concat(_data_history_json__WEBPACK_IMPORTED_MODULE_1__.cards[year].map(function (_ref) {
            var id = _ref.id,
                title = _ref.title,
      ...
      pagination: {
        ...
        renderBullet: function renderBullet(index, bulletClass) {
          return _data_history_json__WEBPACK_IMPORTED_MODULE_1__.years.map(function (year) {
    ...
    var popupSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["Swiper"]('.popup-slider', {
      slidesPerView: 1,
      speed: 0,
      watchSlidesVisibility: true,
      observer: true,
    ...
    var eventSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["Swiper"]('.event__slider', {
      slidesPerView: 1,
      speed: 1000,
      watchSlidesVisibility: true,
      observer: true,
