...
/* harmony import */ var _modules_initIE11__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/initIE11 */ "./js/modules/initIE11.js");
/* harmony import */ var _modules_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/slider */ "./js/modules/slider.js");
/* harmony import */ var _modules_socials_share__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/socials-share */ "./js/modules/socials-share.js");
/* harmony import */ var _modules_initFilter__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/initFilter */ "./js/modules/initFilter.js");
/* harmony import */ var _modules_scrollAnim__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/scrollAnim */ "./js/modules/scrollAnim.js");
...
Object(_modules_initIE11__WEBPACK_IMPORTED_MODULE_3__["initIE11"])();
Object(_modules_slider__WEBPACK_IMPORTED_MODULE_4__["initSlider"])();
Object(_modules_socials_share__WEBPACK_IMPORTED_MODULE_5__["initShare"])();
Object(_modules_initFilter__WEBPACK_IMPORTED_MODULE_6__["initFilter"])();
Object(_modules_scrollAnim__WEBPACK_IMPORTED_MODULE_7__["initScrollAnim"])();
...
var modalSuccessBtns = document.querySelectorAll('[data-modal="success"]'); // const modalFilter = document.querySelector('.modal--filter');
...
var initFilter = function initFilter() {
  var filterOpenBtn = document.querySelector('.header__filter');
  var filterCloseBtn = document.querySelector('.filter__close-btn');
...
/***/ "./js/modules/initIE11.js":
/*!********************************!*\
  !*** ./js/modules/initIE11.js ***!
  \********************************/
/*! exports provided: initIE11 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initIE11", function() { return initIE11; });
var initIE11 = function initIE11() {
  if (Object.hasOwnProperty.call(window, 'ActiveXObject') && !window.ActiveXObject) {
    var wrapper = document.querySelector('.wrapper');
    var IE11 = document.querySelector('.IE11');
...
/***/ "./js/modules/scrollAnim.js":
/*!**********************************!*\
  !*** ./js/modules/scrollAnim.js ***!
  \**********************************/
/*! exports provided: initScrollAnim */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initScrollAnim", function() { return initScrollAnim; });
var initScrollAnim = function initScrollAnim() {
  var MOBILE_WIDTH = 1024;
  var SCROLL_STEP = 10;
  var wrapper = document.querySelector('.wrapper'); // создаем наш обработчик скролла

  var onScrollToggleClass = function onScrollToggleClass() {
  ...
  window.addEventListener('resize', onResize); // при загрузке приложения делаем подписку
...
var URL = 'https://tmk.stillbeta.app/api/cards/all';
...
var renderSlider = function renderSlider(data) {
  ...
  var textContainer = modalSuccess.querySelector('.event__text-container');
  ...
  var videoSrc; // слайдер в модальном
  ...
  var eventsSlider = new Swiper('.event__slider', {
    ...
    on: {
      slideChangeTransitionEnd: function slideChangeTransitionEnd() {
        var videoSlide = popup.querySelector('.swiper-slide--video');

        if (videoSlide) {
          var video = videoSlide.querySelector('iframe');
  ...
  var openCard = function openCard(card) {
    ...
    eventsSlider.appendSlide(slides.map(function (slide) {
      return "\n      <div class=\"event__slide swiper-slide ".concat(slide.video ? 'swiper-slide--video' : '', "\">\n        ").concat(slide.video ? "\n          <iframe width=\"560\" height=\"560\" class=\"loaded-element\" id=\"video\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen\n          data-src=\"".concat(slide.video, "\" src=\"").concat(slide.video, "\">\n          </iframe>\n        ") : "\n          <picture>\n            <!-- 1\u0445: 433px -->\n            <source type=\"image/webp\" srcset=\"".concat(slide.image, "\">\n            <!-- 1\u0445: 433px -->\n            <img class=\"loaded-element\" src=\"").concat(slide.image, "\" alt=\"").concat(title, "\" width=\"433\" height=\"320\" >\n          </picture>\n        "), "\n        </div>\n    ");
    }));
    ...
    orgElement.classList.add("button--".concat(org.id));
    ...
    popup.classList.add("popup--".concat(org.id));
    ...
    var cards = data.cards[currentYear];
    var currentCardIndex = cards.findIndex(function (cardItem) {
      return cardItem === currentCard;
    });
    ...
    var loaded = document.querySelector('.loaded-element');
  ...
  prevCardBtn.addEventListener('click', function () {
    var cards = data.cards[currentYear];
    var currentCardIndex = cards.findIndex(function (card) {
  ...
  var slider = new Swiper(mainSlider, {
    ...
    on: {
      'beforeResize': function beforeResize() {
        var slides = mainSlider.querySelectorAll('.swiper-slide');
  ...
  var buildSlideItem = function buildSlideItem(_ref2) {
    var id = _ref2.id,
        title = _ref2.title,
        cover = _ref2.cover,
        events = _ref2.events,
    ...
    return "\n      <article class=\"slider__card\" data-id=\"".concat(id, "\">\n        <div class=\"slider__link-container\">\n          <a href=\"#\" class=\"slider__link\" data-modal=\"success\" aria-label=\"\" tabindex=\"-1\">\n            <div class=\"slider__img-container\">\n              <div class=\"slider__img-label slider__img-label--").concat(org.id, "\"></div>\n              <picture>\n                <img src=\"").concat(cover, "\" data-srcset=\"").concat(cover, "\" alt=\"").concat(title, "\" width=\"433\" height=\"320\"/>\n              </picture>\n              <div class=\"swiper-lazy-preloader\"></div>\n            </div>\n          </a>\n          <span class=\"button button--events\">").concat(events.map(function (event) {
      return "#".concat(event.title);
    }), "</span>\n          <span class=\"button button--timeline-enterprises button--").concat(org.id, "\" data-org-id=\"").concat(org.id, "\">").concat(org.title, "</span>\n          <h3>").concat(title, "</h3>\n          <p class=\"slider__text\">").concat(short_description, "</p>\n        </div>\n      </article>\n    ");
  };

  var buildSlide = function buildSlide(year) {
    var cards = data.cards[year].filter(function (card) {
      // eslint-disable-next-line max-nested-callbacks
      var hasEvents = !filter.events.length || card.events.some(function (_ref3) {
        var id = _ref3.id;
        return filter.events.some(function (event_id) {
          return event_id === id;
        });
      });
    ...
    var first_year = data.years[0];
    return "\n      <div class=\"slider__slide swiper-slide\" data-year=\"".concat(year, "\">\n        ").concat(year === first_year ? '' : "\n          <div class=\"slider__divider\">\n            <div class=\"slider__divider-line\"></div>\n            <span>\n              ".concat(year, "\n            </span>\n          </div>\n        "), "\n        ").concat(cards.map(buildSlideItem).join(''), "\n    </div>");
  };

  var appendSlides = function appendSlides(year) {
    var slide = buildSlide(year);
  ...
  slider.on('update resize', function () {
  ...
  slider.on('progress', function () {
    ...
    modalSuccessBtns.forEach(function (btn) {
      ...
      var card = data.cards[year].find(function (c) {
        return String(c.id) === cardId;
      });
      Object(_utils_modal__WEBPACK_IMPORTED_MODULE_0__["setupModal"])(modalSuccess, null, [btn], function () {
        currentYear = year;
        openCard(card);
      });
    });
  });
  var currentNum1 = document.querySelector('.time-line__first-number');
  var currentNum2 = document.querySelector('.time-line__second-number');

  var updateYear = function updateYear() {
    var year = filteredYears[slider.realIndex].toString();
  ...
  slider.on('slideChange', function () {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].to(currentNum1, 0.3, {
      force3D: true,
      y: -67,
      onComplete: function onComplete() {
        gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].to(currentNum1, 0, {
          force3D: true,
          y: 67
        });
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].to(currentNum2, 0.3, {
      force3D: true,
      y: -67,
      onComplete: function onComplete() {
        gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].to(currentNum2, 0, {
          force3D: true,
          y: 67
        });
  ...
  slider.on('update slideChange', function () {
    var countPrev = document.querySelector('.time-line__count-prev');
    var countNext = document.querySelector('.time-line__count-next');

    if (countPrev && countNext) {
      var yearPrev = filteredYears[slider.realIndex - 1];
      var yearNext = filteredYears[slider.realIndex + 1];
      countPrev.textContent = yearPrev;
      countNext.textContent = yearNext;
    }
  }); // фильтры

  var filterEnterprisesWraps = document.querySelectorAll('.enterprises-filter');
  var filterEventsWraps = document.querySelectorAll('.events-filter');
  var modalBtn = document.querySelector('.header__filter');
  var filterEventsBtns;
  var filterEnterprisesBtns;

  var checkActiveFilters = function checkActiveFilters() {
    // todo проверка на ширину экрана и retun если не нужна кнопка
    // делаем активной кнопку для открытия модалки
    var active = Array.prototype.some.call(filterEnterprisesBtns, function (btn) {
      return btn.classList.contains('button--active');
    }) || Array.prototype.some.call(filterEventsBtns, function (btn) {
      return btn.classList.contains('button--active');
    });
  ...
  filterEnterprisesWraps.forEach(function (filterEnterprisesWrap) {
    // это фильтры - где карточка???
    filterEnterprisesWrap.innerHTML = data.orgs.map(function (org) {
      return "\n    <li class=\"enterprises-filter__item enterprises-filter__item--".concat(org.id, "\">\n      <button class=\"enterprises-filter__button button button--").concat(org.id, "\" type=\"button\" aria-label=\"\" data-org-id=\"").concat(org.id, "\">\n        <span>").concat(org.short_title, "</span>\n        <span>").concat(org.title, "</span>\n      </button>\n    </li>\n  ");
    }).join('');
    ...
    filterEnterprisesBtns.forEach(function (btn) {
      btn.addEventListener('click', function () {
        return filterEnterpr(btn);
      });
    });

    var filterEnterpr = function filterEnterpr(btn) {
      var orgId = parseInt(btn.dataset.orgId, 10);
      ...
      if (filter.org === orgId) {
        ...
        filter.org = orgId;
        var active = filterEnterprisesWrap.querySelector('.button--active');
      ...
      checkActiveFilters();
      updateSlider(); // const recolorBtns = document.querySelectorAll(`.slider__card .button--${btn.dataset.orgId}`);
  ...
  filterEventsWraps.forEach(function (filterEventsWrap) {
    filterEventsWrap.innerHTML = data.events.map(function (event) {
      return "\n    <li>\n      <button class=\"events-filter__button button button--events\" type=\"button\" data-event-id=\"".concat(event.id, "\" aria-label=\"\">#").concat(event.title, "</button>\n    </li>\n  ");
    }).join('');
    filterEventsBtns = filterEventsWrap.querySelectorAll('.events-filter__button');
    filterEventsBtns.forEach(function (btn) {
      btn.addEventListener('click', function () {
        return filterEvents(btn);
      });
    });
    ...
    var filterEvents = function filterEvents(btn) {
      ...
      checkActiveFilters();
      updateSlider(); // const recolorBtns2 = document.querySelectorAll('.slider__card .button--events');
...
/***/ "./js/modules/socials-share.js":
/*!*************************************!*\
  !*** ./js/modules/socials-share.js ***!
  \*************************************/
/*! exports provided: initShare */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var initShare = function initShare() {
  var share = document.querySelector('.js-footer-social');

  var insertIcon = function insertIcon(id, link) {
    var template = "\n    <svg width=\"20\" height=\"20\">\n      <use xlink:href=\"#".concat(id, "\"></use>\n    </svg>\n    ");
  ...
  var addClasses = function addClasses(container) {
    var list = container.querySelector('.ya-share2__list');

    if (!list) {
      return;
    }

    var items = list.querySelectorAll('.ya-share2__item');
    var links = list.querySelectorAll('.ya-share2__link');
  ...
  var addIcons = function addIcons(container) {
    var fbLink = container.querySelector('.ya-share2__item_service_facebook a');
    var tgLink = container.querySelector('.ya-share2__item_service_telegram a');
    var twLink = container.querySelector('.ya-share2__item_service_twitter a');
  ...
  if (share) {
    var shareUrl = share.dataset.url;
    Ya.share2(share, {
      content: {
        url: shareUrl,
...
var closeModal = function closeModal(modal, callback, preventScrollLock) {
  ...
  var textContainer = document.querySelector('.event__text-container');
  textContainer.scrollTo(0, 0);
};
...
var setModalListeners = function setModalListeners(modal, closeCallback, preventScrollLock) {
  ...
  var closeBtn = modal.querySelectorAll('.modal__close-btn');
