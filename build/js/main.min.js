...
var initScrollAnim = function initScrollAnim() {
  ...
  var SCROLL_STEP = 10;
  var wrapper = document.querySelector('.wrapper'); // вынесем поиск элемента из функции - он же всегда на странице (лишняя операция)
...
var renderSlider = function renderSlider(data) {
  ...
  var headerFilterBtn = document.querySelector('.header__filter');
  ...
  var buildSlideItem = function buildSlideItem(_ref2) {
    ...
    }), "</span>\n          <span class=\"button button--timeline-enterprises button--").concat(org.id, "\">").concat(org.title, "</span>\n          <h3>").concat(title, "</h3>\n          <p class=\"slider__text\">").concat(short_description, "</p>\n        </div>\n      </article>\n    ");
  };
  ...
  filterEnterprisesWraps.forEach(function (filterEnterprisesWrap) {
    ...
    var filterEnterpr = function filterEnterpr(btn) {
      var orgId = parseInt(btn.dataset.orgId);
